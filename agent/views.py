...
from rentals.models import  Activity, Amenities, Attributes, Bookings, Category, Channel, CompanyProfile, Discount, DiscountType,Currency, Invoice, InvoiceItem, Partner, Policy, Rate, Ratetype, Rental, RentalsGallery, Rentaltype, Tax, Taxtype, UserProfile
